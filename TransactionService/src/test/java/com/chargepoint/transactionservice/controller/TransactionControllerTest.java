...
class TransactionControllerTest {
    ...
    @Test
    @DisplayName("Should return 200 OK and Accepted when authorization is successful")
    void testAuthorizeSuccess() throws Exception {
        ...
        Mockito.when(transactionService.authorize(any(AuthorizationRequest.class))).thenReturn(response);
    ...
    @Test
    @DisplayName("Should return 400 Bad Request when identifier is invalid")
